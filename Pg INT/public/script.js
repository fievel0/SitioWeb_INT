...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function onClickToast() {
    // lógica opcional o navegación
  }

  // Mostrar el toast 1 segundo después de cargar la página
  setTimeout(() => {
    toastt.classList.add('show');
  }, 1000);

  // Ocultar el toast después de 10 segundos y quitar el event listener
  setTimeout(() => {
    toastt.classList.remove('show');
    toastt.classList.add('hide');

    // Remover el listener para que ya no se pueda hacer clic
